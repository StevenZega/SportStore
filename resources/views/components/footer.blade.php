    ...
    <div class="footer-area section-space--pb_90">
        <div class="container-fluid container-fluid--cp-100">
            <div class="row footer-widget-wrapper">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 footer-widget">
                    <h5 class="footer-widget__title mb-20">Social Media</h5>
                    <ul class="footer-widget__list">
                        <li><a href="#" class="hover-style-link">Facebook</a></li>
                        <li><a href="#" class="hover-style-link">Twitter</a></li>
                        <li><a href="https://www.instagram.com/blue_viking_store/" target="_blank class="hover-style-link">Instagram</a></li>
                    </ul>
                </div>

                <div class="col-lg-3 col-md-6 col-sm-6 footer-widget">
                    <h5 class="footer-widget__title mb-20">Newsletter</h5>
        ...
        <div class="container-fluid container-fluid--cp-100">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 order-md-1 order-2">
                    <span class="copyright-text text-center text-md-start">&copy; 2024 Blue Viking.
                ...
                <div class="col-lg-6 col-md-6 order-md-2 order-1">
                    <div class="footer-bottom-social">
                        <ul class="list footer-social-networks ">
                            ...
                            <li class="item">
                                <a href="https://www.instagram.com/blue_viking_store/" target="_blank" aria-label="Instagram">
